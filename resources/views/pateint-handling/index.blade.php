...
<head>
    ...
    <title>
        {{ env('APP_NAME') }} Pateint Handling Dashboard
    </title>
...
<body>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <div class="flex ms-2 md:me-24">
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">{{ env('APP_NAME') }}
    ...
    <div class="p-4 sm:ml-64 p-4 mt-14">
        @livewire('patientHandling.newAppointments')
    </div>
