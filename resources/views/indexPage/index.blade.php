...
<body>
    ...
    <nav class="bg-white px-4 py-2 mt-3">
        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <ul class="hidden md:flex gap-8 items-center">
                ...
                {{-- <li class="relative group">
                    <button
                        class="flex items-center gap-2 font-semibold text-gray-700 hover:text-blue-600 focus:outline-none">
                        <span>{{ $org['org_name'] ?? 'Organization' }}</span>
                        <svg width="20" height="20" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-width="2" d="M7 10l5 5 5-5" />
                        </svg>
                    </button>

                    @if (session()->has('organization_data'))
                        @php $org = session('organization_data'); @endphp
                        <ul
                            class="rubik absolute left-0 mt-2 w-64 bg-white text-gray-800 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all z-50">
                            <li class="rubik px-4 py-2 border-b border-gray-200">
                                <marquee behavior="loop" direction="left">
                                    <strong>Email:</strong> {{ $org['org_email'] }}
                                </marquee>
                            </li>
                            <li class="rubik px-4 py-2 border-b border-gray-200">
                                <strong>Mobile:</strong> {{ $org['org_mobile'] }}
                            </li>
                            <li class="rubik px-4 py-2 border-b border-gray-200">
                                <strong>Type:</strong> {{ $org['org_type'] }}
                            </li>
                            <li class="rubik px-4 py-2 border-b border-gray-200">
                                <strong>Employees:</strong> {{ $org['org_num_emp'] }}
                            </li>
                            <li class="rubik px-4 py-2">
                                <strong>Created:</strong>
                                {{ \Carbon\Carbon::parse($org['created_at'])->format('d M Y') }}
                            </li>
                        </ul>
                    @else
                        <ul
                            class="absolute left-0 mt-2 w-64 bg-black text-white rounded-lg shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all z-50">
                            <li class="px-4 py-2 border-b border-gray-200">Unset</li>
                        </ul>
                    @endif
                </li> --}}
    ...
    <div class="bg-gradient-to-b from-white to-slate-50 py-24 px-6 sm:px-10 lg:px-20 text-center font-sans">
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <p class="text-lg text-slate-600 tracking-tight mb-4">
                Welcome to <span class="border-b border-dotted border-slate-400">{{ env('APP_NAME') }}</span>
            </p>
    ...
    <div class="box box1 container mx-auto flex flex-col md:flex-row items-center gap-8 py-10 px-4">
        ...
        <div class="md:w-1/2 w-full flex justify-center mb-6 md:mb-0">
            <img src="{{ asset('portelImages/8264c48a8f26eada143f5fdd67f81c36.jpg') }}"
