...
<head>
    ...
    <title>
        <?php echo e(env('APP_NAME')); ?> Dashboard
    </title>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        ...
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white"><?php echo e(env('APP_NAME')); ?></span>
                    </a>
                </div>
...
[$__name, $__params] = $__split(' new-appointments.register_new_app');

$__html = app('livewire')->mount($__name, $__params, 'lw-2178712528-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH D:\healthclient\client1.1\resources\views/dashboard/index.blade.php ENDPATH**/ ?>